...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported in either of the following ways:

- **On a specific issue, pull request, or comment**: use GitHub's built-in **Report content** action (available from the `···` menu), which routes the report to repository admins.
- **For anything broader**, or if you're not comfortable using the option above: contact a project maintainer directly through GitHub.
